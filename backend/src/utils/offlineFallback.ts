...
export const DEMO_PROFILES: DemoProfile[] = [
  ...
  {
    id: 'demo-tech-cm',
    technicianId: 'T097262',
    name: 'Christian MATHIEU',
    password: '!*A1Z2E3R4T5!',
    role: 'TECHNICIAN',
    isActive: true,
  },
  {
    id: 'demo-tech-eb',
    technicianId: 'T097966',
    name: 'Etienne BLASZCZYK',
    password: '!*A1Z2E3R4T5!',
    role: 'TECHNICIAN',
    isActive: true,
  },
  {
    id: 'demo-tech-fj',
    technicianId: 'T099007',
    name: 'Florian JOVE GARCIA',
    password: '!*A1Z2E3R4T5!',
    role: 'TECHNICIAN',
    isActive: true,
  },
