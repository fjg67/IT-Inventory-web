  ...
  return (
    <footer className="mt-16 pt-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Col 1 — Signature */}
        <div>
          <p className="font-['Outfit'] text-lg font-extrabold text-slate-100">
            IT-Inventory
          </p>
        ...
        <div>
          <p className="text-[11px] font-['Outfit'] font-bold uppercase tracking-[0.1em] text-slate-500 mb-3">
            Pages légales
          </p>
          <div className="space-y-2">
            <button
              onClick={() => onTabChange('terms')}
              className="block text-[13px] font-['Outfit'] text-slate-400 hover:text-blue-400 transition-colors"
            >
      ...
      {/* Dernière ligne */}
      <div className="flex flex-col sm:flex-row justify-between items-center gap-2 mt-6 pt-4 border-t border-white/[0.06]">
        <p className="text-[11px] font-['Lora'] italic text-slate-600">
          Ces documents sont applicables à partir du 15 janvier 2026
        </p>
        <span className="text-[11px] font-['JetBrains_Mono'] text-slate-600">
          Version 1.0.0
        </span>
      </div>
    </footer>
